...
-- Countries with Highest Death Count per Population on single day
...
-- Total deaths betwen 2020 to 2021 April

select * From CovidAnalysis..CovidDeaths where continent is not null 
